- Gameplay/Encounters: Replace wild Marill encounter slots with Lotad (commit pending).
- Docs/Gameplay: Note the Marill-to-Lotad wild encounter swap in blind-friendly notes (commit pending).
