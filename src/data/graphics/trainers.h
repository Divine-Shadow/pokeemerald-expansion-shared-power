...
const u32 gTrainerFrontPic_BerryBarry[] = INCBIN_U32("graphics/trainers/front_pics/berry_barry.4bpp.smol");
const u16 gTrainerPalette_BerryBarry[] = INCBIN_U16("graphics/trainers/front_pics/berry_barry.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_BERRY_BARRY, gTrainerFrontPic_BerryBarry, gTrainerPalette_BerryBarry),
};
