...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_BOLDORE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_GIGALITH}),
    },
    ...
    [SPECIES_GURDURR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_CONKELDURR}),
    },
    ...
    [SPECIES_KARRABLAST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 1, SPECIES_ESCAVALIER}),
    },
    ...
    [SPECIES_SHELMET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 1, SPECIES_ACCELGOR}),
    },
