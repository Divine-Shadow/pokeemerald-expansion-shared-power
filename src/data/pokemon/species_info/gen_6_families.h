...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 1, SPECIES_AROMATISSE, CONDITIONS({IF_HOLD_ITEM, ITEM_SACHET})}),
    },
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 1, SPECIES_SLURPUFF, CONDITIONS({IF_HOLD_ITEM, ITEM_WHIPPED_DREAM})}),
    },
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 1, SPECIES_TREVENANT}),
    },
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 1, SPECIES_GOURGEIST_AVERAGE}),
    },
    ...
    [SPECIES_PUMPKABOO_SMALL] =
    {
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 1, SPECIES_GOURGEIST_SMALL}),
    },
    ...
    [SPECIES_PUMPKABOO_LARGE] =
    {
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 1, SPECIES_GOURGEIST_LARGE}),
    },
    ...
    [SPECIES_PUMPKABOO_SUPER] =
    {
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 1, SPECIES_GOURGEIST_SUPER}),
    },
