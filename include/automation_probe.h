...
enum AutomationProbeCommand
{
    ...
    AUTOMATION_PROBE_COMMAND_SHOW_JOURNEY_NPC_SPRITE_PREVIEW,
    AUTOMATION_PROBE_COMMAND_SHOW_BARRY_SPRITE_PREVIEW = AUTOMATION_PROBE_COMMAND_SHOW_JOURNEY_NPC_SPRITE_PREVIEW,
};
