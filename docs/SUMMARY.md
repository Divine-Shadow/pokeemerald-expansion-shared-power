...
- [Team Procedures]()
 ...
 - [Design]()
   ...
   - [Shared Power Mode](design/shared_power/README.md)
     ...
     - [Core API](design/shared_power/api.md)
     - [Acquisition & Switch-In Flow](design/shared_power/acquisition_switchin.md)
     - [Events & Dispatchers](design/shared_power/events.md)
     - [Damage Calc & Continuous](design/shared_power/damage_calc.md)
     - [Suppression & Edge Cases](design/shared_power/suppression_edge_cases.md)
     - [AI Integration](design/shared_power/ai.md)
