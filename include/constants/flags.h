...
#define FLAG_WILD_HELD_ITEM_BROKER_UNLOCKED  0x1DA
...
#define FLAG_NO_BATTLE_AID_ITEMS  0x264 // If set, combat aid items cannot be used in battle.
...
#define FLAG_RECEIVED_RADIANT_CHARM                 (SYSTEM_FLAGS + 0x85)
